...
import { User, Session } from '../sequelize/mysql/models';
...
// export const getBySessionToken = async (sessionToken: string): Promise<UserOuput> => {
// 	console.log('UserDal getBySessionToken', sessionToken);
...
// 		}
// 	});
// 	console.log('getBySessionToken user', user);
