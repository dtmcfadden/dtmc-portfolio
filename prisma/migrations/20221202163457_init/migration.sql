...
-- AddForeignKey
ALTER TABLE `todocatentry` ADD CONSTRAINT `todocatentry_userId_categoryId_fkey` FOREIGN KEY (`userId`, `categoryId`) REFERENCES `todocategory`(`userId`, `categoryId`) ON DELETE CASCADE ON UPDATE CASCADE;
